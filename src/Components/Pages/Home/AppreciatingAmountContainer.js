...
const AppreciatingAmountContainer = () => {
    return (
        <div className='bg-background text-white py-[80px]'>
        ...
        <div className='px-[80px] pt-[50px] pb-[80px] md:flex md:flex-row  flex-col justify-center gap-[25px]'>
            <div className='border border-pink-400 w-[302px] h-[164px] rounded py-[30px] px-[40px] md:m-0 mt-4'>
                <h1 className='text-2xl font-sans'>Clients helped</h1>
                <h1 className='text-5xl font-bold'>13</h1>
            </div>
            <div className='border  w-[302px] h-[164px] rounded py-[30px] px-[40px] md:m-0 mt-4'>
