...
const Footer = () => {
    return (
       <div className='bg-custom-blue py-[80px] md:p-0 px-4'>
        ...
        <Link to='/register'>
        <button className='btn bg-red-500 rounded-xl p-3 mt-[20px] text-white text-center bg-gradient-to-r from-first to-second md:mb-0 mb-8 font-bold'>Register Now</button>
        </Link>
        </div>
